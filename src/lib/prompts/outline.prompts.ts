...
3. 限制条件：
   - 严格遵循输入: 所有设计必须以用户提供的\`\${title}\`, \`\${category}\`, \`\${summary}\`, \`\${estimatedChapters}\`, \`\${style}\`, \`\${tone}\`为基础和约束。
...
- 步骤 1: **深度解析与构思**。仔细分析用户输入的小说信息，特别是故事简介、写作风格和整体基调。识别出主角的初始状态、核心欲望/目标、主要对手/障碍以及故事的潜在主题。
