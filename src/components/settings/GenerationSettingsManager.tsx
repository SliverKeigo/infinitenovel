...
const presets: Record<PresetName, Omit<GenerationSettings, 'id'>> = {
    'Balanced Mode': { chapterWordCount: 1500, temperature: 0.7, maxTokens: 2048, maxCharacterCount: 5, characterCreativity: 0.6, contextChapters: 3 },
    'Creativity First': { chapterWordCount: 1200, temperature: 0.95, maxTokens: 2048, maxCharacterCount: 7, characterCreativity: 0.9, contextChapters: 2 },
    'Logic First': { chapterWordCount: 1800, temperature: 0.4, maxTokens: 3072, maxCharacterCount: 4, characterCreativity: 0.4, contextChapters: 5 },
    'Long-form Novel': { chapterWordCount: 2500, temperature: 0.65, maxTokens: 4096, maxCharacterCount: 10, characterCreativity: 0.5, contextChapters: 6 },
    'Short Story': { chapterWordCount: 800, temperature: 0.8, maxTokens: 1024, maxCharacterCount: 3, characterCreativity: 0.7, contextChapters: 1 },
};
